...
public class RegisterOneAct extends AppCompatActivity {
    ...
    private static final String TAG = "RegisterOneAct";
                        ...
                        reference_username.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    //Save to Database
                                    User user = new User();
                                    user.setUsername(xusername.getText().toString());
                                    user.setPassword(xpassword.getText().toString());
                                    user.setEmail(xemail_address.getText().toString());
                                    user.setBalance(800);
                                    ...
                                    reference.setValue(user)
                                            .addOnCompleteListener(task -> {
                                                ...
                                                intent.putExtra(RegisterTwoAct.DATA_USER_EXTRA, user);
                                                startActivity(
                                                        new Intent(intent)
                                                );
                                                finish();
                                            }).addOnFailureListener(e -> {
                                        Log.d(TAG, "Error onFailure setData: " + e.getMessage());
                                    });
                                }
                            }
